...
Setup:
  Given members:
  | id   | fullName | address | city | state | postalCode | email | flags        | minimum | achMin |*
  | .ZZA | Abe One  | 1 A St. | Aton | MA    | 01000      | a@    | ok,bona      |     100 |     10 |
  | .ZZB | Bea Two  | 2 B St. | Bton | MA    | 02000      | b@    | ok,bona,debt |     200 |     20 |
  | .ZZC | Cor Pub  | 3 C St. | Cton | CA    | 03000      | c@    | ok,co,bona   |     300 |     30 |
  | .ZZD | Dee Four | 4 D St. | Dton | DE    | 04000      | b@    | ok,admin     |     400 |     40 |

Scenario: A member changes some settings
  Given member ".ZZA" completes form "account/preferences" with values:
  | minimum | achMin | smsNotices | notices | statements | debtOk | secretBal |*
  |     100 |     11 |          0 |       1 |          0 |      1 |         0 |
