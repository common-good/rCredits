...
Scenario: A member updates contact info
  ...
  | fullName | phone        | country | postalCode | state | city    | address   | postalAddr |
  | Abe One  | 413-253-0001 | US      | 01002      | MA    | Amherst | 2 Elm St. | PO Box 1   |
  Then members:
  | id   | fullName   | address   | city    | state | postalCode | country | postalAddr | phone       |
  | .ZZA | Abe One    | 2 Elm St. | Amherst | MA    | 01002      | US      | PO Box 1   | 14132530001 |
  And we say "status": "info saved"
  
Scenario: A member gives a bad phone
  When member ".ZZA" confirms form "account/contact" with values:
  | fullName | phone   | country | postalCode | state | city    | address   | postalAddr |
  | Abe One  | %random | US      | 01002      | MA    | Amherst | 2 Elm St. | PO Box 1   |
