...
Setup:
  ...
  | 5001 |  .ZZA |    -99 |   1 | %today-7d | %today-5d |
  | 5002 |  .ZZA |   -100 |   2 | %today-5d |         0 |
  | 5003 |  .ZZA |     13 |   3 | %today-2d | %today-2d |
  | 5004 |  .ZZB |      4 |   1 | %today-2d | %today-2d |
  | 5005 |  .ZZC |    -30 |   1 | %today-2d | %today-2d |
  | 5006 |  .ZZD |   -140 |   1 | %today-2d | %today-2d |
  Then balances:
  | id   | r    | rewards |*
  | .ZZA |  106 |      20 |
  | .ZZB |   96 |       0 |
