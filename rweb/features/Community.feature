...
Setup:
  ...
  | .AABF | %today-1d | transfer  | done    |      0 |  10 | ctty | .ZZA | exchange| 0     | %TX_CRON |
  | .AABG | %today-1d | transfer  | done    | 1 | 1 | .ZZC | .AAB | sharing rewards with CGF | 1 | %TX_CRON |
  Then balances:
  | id   | r       | usd      | rewards | committed |
  | ctty | -823.15 | 10010.00 |    0.00 |         0 |
  | .ZZA |  243.00 |   680.00 |  269.00 |      1.80 |
  ...
  Then balances:
  | id   | r       | usd      | rewards    |
  | ctty | -824.65 | 10010.00 |       0.00 |
  | .ZZA |  243.25 |   679.75 |     269.25 |
