...
Setup:
  ...
  | .ZZA | Abe One    | a@    | dft,ok,dw,person,bona  |       5 |     0 |    10 | %today-2m |
  | .ZZB | Bea Two    | b@    | dft,ok,dw,person,bona  |    1000 |   -20 |    20 | %today-3w |
  | .ZZC | Corner Pub | b@    | dft,ok,dw,company,bona |    2000 |    10 |    30 | %today-2w |
  And relations:
