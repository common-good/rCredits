...
Setup:
  ...
  | .AAAW | %today-2d | inflation | done    |      1 |   1 | community | .ZZA | inflate | 0      |
  | .AAAX | %today-2d | inflation | done    |      2 |   2 | community | .ZZB | inflate | 0      |
  | .AAAY | %today-2d | inflation | done    |      3 |   3 | community | .ZZC | inflate | 0      |
  | .AAAZ | %today-2d | grant     | done    |      4 |   2 | community | .ZZA | grant   | 0      |
  | .AABA | %today-2d | loan      | done    |      5 |   3 | community | .ZZB | loan    | 0      |
  | .AABB | %today-2d | fine      | done    |      6 |   4 | community | .ZZC | fine    | 1      |
  Then balances:
  | id        | r    | usd      | rewards |
  | community | -789 | 10000.00 |       0 |
  | .ZZA      |  171 |   741.75 |     261 |
  | .ZZB      |  286 |  2256.50 |     261 |
  | .ZZC      |  320 |  3002.50 |     255 |
...
Scenario: cron calculates the totals
  ...
  | 789 |   -10 |     789 | 6000.75 |    3005 |      51 | 6738.75 | 750 |     16 |    32 |         6 |     4 |    5 |   6 |         4 |    -789 |   2216 |
